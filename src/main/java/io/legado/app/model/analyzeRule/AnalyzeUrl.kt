    ...
    suspend fun getStrResponseAwait(
        ...
        if (this.useWebView && useWebView) {
            ...
            strResponse = when (method) {
                ...
                else -> ReaderAdapterHelper.getAdapter().getStrResponseByRemoteWebview(
                    url = url,
                    tag = source?.getKey(),
                    javaScript = webJs ?: jsStr,
                    sourceRegex = sourceRegex,
